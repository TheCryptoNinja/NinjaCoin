...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("NINJA");
    case mBTC: return QString("mNINJA");
    case uBTC: return QString::fromUtf8("μNINJA");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("NINJA");
    case mBTC: return QString("Milli-NINJA (1 / 1,000)");
    case uBTC: return QString("Micro-NINJA (1 / 1,000,000)");
    default: return QString("???");
    }
}
